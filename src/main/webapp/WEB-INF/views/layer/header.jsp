                ...
                <div class="container-fluid px-4">
                    <a class="navbar-brand p-0 me-3" href="${pageContext.request.contextPath}/dashboard">
                        <img src="${pageContext.request.contextPath}/resources/static/images/pos-logo.png"
                            alt="POS System Logo" style="height: 50px; width: auto; object-fit: contain;">
                    </a>
                        ...
                        <button class="btn btn-light d-flex align-items-center gap-2 border-0 bg-transparent"
                            ...
                            <div class="text-end" style="line-height: 1.2;">
                                ...
                                <span class="d-block text-muted"
                                    style="font-size: 11px;">${account.employee.role}</span>
                            </div>
                            ...
                            <li class="px-3 py-3">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="user-avatar-container">
                                        <img src="https://ui-avatars.com/api/?name=${account.username}&background=f1f5f9&color=64748b"
                                    ...
                                    <div class="user-details">
                                        ...
                                        <div class="d-flex gap-1 mt-1">
                                            <span class="user-badge-pill role-pill">
                                                <i
                                                    class="fa-solid ${account.employee.role == 'MANAGER' ? 'fa-user-tie' : 'fa-cash-register'}"></i>
                                                ${account.employee.role}
                                            </span>
                                            <span
                                                class="user-badge-pill status-pill ${account.employee.status ? 'status-active-header' : 'status-inactive-header'}">
                                                <i
                                                    class="fa-solid ${account.employee.status ? 'fa-circle-check' : 'fa-circle-xmark'}"></i>
