<%-- ============================================================
     Page   : Manage Product
     Purpose: Hiển thị danh sách sản phẩm, thống kê tổng quan,
              bộ lọc tìm kiếm và các thao tác CRUD trên sản phẩm.
     ============================================================ --%>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <%-- Export to Excel --%>
                <a href="<c:url value='/products/export-excel' />"
                ...
                <a href="<c:url value='/products/add' />"
                   class="btn btn-add px-4 py-2 d-inline-flex align-items-center text-decoration-none">
                ...
                <table class="table table-hover align-middle">
                    ...
                    <thead>
                        <tr class="thead-row">
                                ...
                                <a href="?sortField=productId&sortDir=${reverseSortDir}${not empty param.keyword ? '&keyword='.concat(param.keyword) : ''}"
                                   class="text-decoration-none th-link">
                                    ...
                                    <i class="fa-solid ${sortField == 'productId'
                                        ...
                                        : 'fa-sort'} ms-1 small"></i>
                                </a>
                            </th>

                            <%-- Sortable: Product Name --%>
                            <th class="th-cell">
                                <a href="?sortField=productName&sortDir=${reverseSortDir}"
                                   class="text-decoration-none th-link">
                                    Product Name
                                    <i class="fa-solid ${sortField == 'productName'
                                        ? (sortDir == 'asc' ? 'fa-sort-up' : 'fa-sort-down')
                                        : 'fa-sort'} ms-1 small"></i>
                                </a>
                            </th>
                            ...
                            <%-- Sortable: Unit Price --%>
                            <th class="th-cell">
                                <a href="?sortField=price&sortDir=${reverseSortDir}"
                                   class="text-decoration-none th-link">
                                    Unit Price
                                    <i class="fa-solid ${sortField == 'price'
                                        ? (sortDir == 'asc' ? 'fa-sort-up' : 'fa-sort-down')
                                        : 'fa-sort'} ms-1 small"></i>
                                </a>
                            </th>
                    ...
                    <%-- Table Body: Iterate over product list --%>
                    <tbody>
                        <c:forEach var="p" items="${listProducts}">
                            <tr>
                                ...
                                <%-- Status Badge: dynamic CSS class based on status name --%>
                                <td class="td-cell">
                                ...
                                <%-- Actions Dropdown (View / Update / Delete) --%>
                                <td class="td-cell text-end">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 py-2"
                                            style="min-width: 160px; border-radius: 12px; z-index: 1060;">

                                            <li class="px-2 pb-1 text-muted small fw-bold">Action</li>

                                            <%-- View Detail (opens modal via JS) --%>
                                            <li>
                                            ...
                                            <li>
                                                <a class="dropdown-item rounded-2 py-2"
                                                   href="<c:url value='/products/update/${p.productId}'/>">
                                            ...
                                            <%-- Delete Product (confirmation handled by SweetAlert2 in JS) --%>
                                            <li>
    ...
    <%-- ── Product Detail Modal (content loaded via AJAX) ── --%>
    <div class="modal fade" id="productDetailModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <%-- Modal body is populated dynamically by product-app.js --%>
    ...
    <%-- ── Internal JS (filter, delete confirm, view detail) ── --%>
